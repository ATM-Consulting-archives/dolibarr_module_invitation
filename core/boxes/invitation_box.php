 ...
 */
class invitationbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "invitation@invitation";
    public $boxlabel;
    public $depends = array("invitation");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/invitation/class/invitation.class.php";
